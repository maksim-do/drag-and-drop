...
},{"../es":"node_modules/core-js/es/index.js","../web":"node_modules/core-js/web/index.js","../internals/path":"node_modules/core-js/internals/path.js"}],"js/application.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default() {
  var birthPlace = document.querySelector('.block__create');
  var hopePlace = document.querySelector('.block__hoop');
  var orderPlace = document.querySelector('.block__order'); // инициализируем переменную, для хранения перемещаемого элемента
  ...
  var moveAt = function moveAt(e) {
    stroller.style.left = "".concat(e.pageX - 50, "px");
    stroller.style.top = "".concat(e.pageY - 50, "px");
  };

  var movePointer = function movePointer(e) {
    e.preventDefault();
    moveAt(e);
  }; // Создаем div и привязываем его перемещение к координатам указателя


  birthPlace.addEventListener('pointerdown', function (e) {
  ...
  hopePlace.addEventListener('pointerup', function (e) {
    if (stroller === null) return;
    e.target.append(stroller);
    stroller.style.left = "".concat(e.offsetX - 50, "px");
    stroller.style.top = "".concat(e.offsetY - 50, "px");
    stroller = null;
  });
  orderPlace.addEventListener('pointerup', function (e) {
    if (stroller === null) return;
...
},{"core-js/stable":"node_modules/core-js/stable/index.js","./application":"js/application.js"}],"../.nvm/versions/node/v12.13.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
